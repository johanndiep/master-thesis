...
% where the SPGP-augmented UWB range measurement model is used. The control
...
Model = ConstantVelocityGP(Xa,Ya,Kernel,NoiseStd,s0,s1,AnchorPos,Xi);
tic;
...
save('SPGPCircConData.mat','SaveViconPos','SaveViconQuat', ...
