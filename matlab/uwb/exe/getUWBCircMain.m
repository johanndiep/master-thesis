...
%
% With this script, UWB range measurement can be gathered while the drone
...
%   5. Calibrate the VICON system and place the origin in the room with the
%      T-link, here the T-link should be placed in the middle of the room
%   6. Attach VICON markers on the Bebop, group the markers on the VICON
%      Tracker to an object and name it "Bebop_Johann"
%   7. Place the drone such that the body-fixed frame (x-forward,y-left,z-ascend)
%      is aligned with the VICON frame
%   8. Connect the computer with the VICON machine via Ethernet
%   9. Turn on the Bebop and connect the laptop with it over Wi-Fi
%   10. Start the ROS driver for the Spacemouse, turn it on
%   11. Start the ROS VICON bridge node
